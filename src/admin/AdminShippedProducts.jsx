            ...
            {/* Admin Panel Start */}
             <div className="flex">
                <div className="adminContainer1 flex flex-col pt-20 bg-white justify-start items-start w-96 h-[88vh]">
                  ...
                  <Link to={'/AdminShippedProducts'} className="w-full"><button className="adminBtn pl-8 hover:bg-blue-50 flex items-center gap-4 bg-blue-50 text-blue-800 border-r-4 border-blue-700 px-3 py-2 w-full font-bold text-start text-xl mb-6"><TruckOutlined className="text-2xl"/> Shipped Orders</button></Link>
                </div>
            
                 <div className="flex items-center justify-center bg-gray-100 w-full h-[88vh]">
                     <div className="bg-gray-100 w-full h-[88vh] p-10"> 
                          <h1 className='text-blue-600 mb-6 -mt-2 text-3xl font-bold text-center'><span className='text-black'>Shipped</span> Products <TruckOutlined className="text-2xl"/></h1>
...
export default AdminShippedProducts;