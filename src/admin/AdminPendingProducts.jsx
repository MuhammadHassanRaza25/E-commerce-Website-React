...
import { BarChartOutlined, FieldTimeOutlined, ShopOutlined, ShoppingOutlined, TruckOutlined, UserOutlined } from "@ant-design/icons";
        ...
        {/* Admin Panel Start */}
         <div className="flex">
            <div className="adminContainer1 flex flex-col pt-20 bg-white justify-start items-start w-96 h-[88vh]">
              ...
              <Link to={'/AdminPendingProducts'} className="w-full"><button className="adminBtn pl-8 hover:bg-blue-50 flex items-center gap-4 bg-blue-50 text-blue-800 border-r-4 border-blue-700 px-3 py-2 w-full font-bold text-start text-xl mb-6"><FieldTimeOutlined className="text-2xl"/> Pending Orders</button></Link>
            ...
            <div className="flex items-center justify-center bg-gray-100 w-full h-[88vh]">
               <div className="bg-gray-100 w-full h-[88vh] p-10"> 
                     <h1 className='text-blue-600 mb-6 -mt-2 text-3xl font-bold text-center'><span className='text-black'>Pending</span> Products <FieldTimeOutlined className="text-2xl"/></h1>
                     
                     {/* Table Work get data from db */}
                      <div className="scrollbar w-full drop-shadow-xl bg-white h-[68vh] overflow-scroll">
                             ...
                             return(
                               <>
                                 <div className="flex justify-between bg-white text-black font-bold p-3">
                                     ...
                                     <h1 className="scrollbar h-10 text-center w-full overflow-scroll"><DeleteOutlined className="bg-red-50 text-red-500 hover:text-white hover:bg-red-400 px-3 py-1.5 text-lg rounded-md"/></h1>
                                 </div>
                                 </>
                             )
                           })} */}
