import { createUserWithEmailAndPassword, GoogleAuthProvider, reload, signInWithPopup, updateProfile } from "firebase/auth";
    ...
    <>
      <div className="bg-gray-100 flex items-center justify-center h-screen w-full">
        <div className="signupForm p-5">
          ...
          {/* buttons ⬇ */}
          <button className="loginSignupBtn flex justify-center bg-blue-600 hover:bg-blue-400 mt-3 p-3 text-white font-bold text-lg rounded-lg"
