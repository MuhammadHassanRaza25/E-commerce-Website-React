    ...
    <>
      <div className="bg-gray-100 flex items-center justify-center h-screen w-full">
        <div className="loginForm p-5">
          ...
          {/* buttons ⬇ */}
          <button
            className="loginSignupBtn flex justify-center bg-blue-600 hover:bg-blue-400 mt-5 p-3 text-white font-bold text-lg rounded-lg"
            onClick={signInUser}
          >
          ...
          <div className="flex justify-center">
            <button
              ...
              className="flex gap-10 items-center justify-center bg-gray-100 w-full text-gray-500 text-lg font-semibold p-2.5 rounded-lg mt-5"
            >
